...
export function Hero() {
  ...
  const getBandPill = () => {
    ...
    const bandConfig = {
      ...
      yellow: { text: 'Promising', color: 'bg-yellow-100 text-yellow-700 border-yellow-200' },
      green: { text: 'Strong core', color: 'bg-state-success/10 text-state-success border-state-success/20' }
    }
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            {/* Micro-confidence row */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.6 }}
              className="flex flex-wrap items-center gap-6 text-sm text-ink-600"
            >
