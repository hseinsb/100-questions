...
export function OldNewSection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-b from-white to-cloud">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-12">
          ...
          >
            <div className="bg-heart text-white px-8 py-4 rounded-full font-semibold shadow-lg">
