                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {question.options.map((option) => (
                        <label
                          key={option.value}
                          className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:border-trust/50 hover:bg-trust/5 transition-all duration-200 cursor-pointer"
                        >
                          <input
                            type="radio"
                            ...
                            className="w-4 h-4 text-trust focus:ring-trust"
                          />
                    ...
                    <>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-center space-x-2 text-sm text-gray-500">
                          ...
                          <span>115 pages • Instant download • 30-day guarantee</span>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="text-trust hover:text-trust/80 text-sm font-medium"
                      >
