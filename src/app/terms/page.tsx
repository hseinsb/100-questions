          ...
          <div className="prose prose-gray max-w-none space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-1">
                <li>All purchases are final unless refunded under our 30-day guarantee</li>
            ...
            <section>
              <h2 className="font-heading font-semibold text-xl text-ink mb-3">30-Day Money-Back Guarantee</h2>
              <p className="text-gray-600">
                If you're not satisfied with the guide, you may request a full refund within 30 days 
                of purchase by emailing hussein.sbeiti.wb@gmail.com. No questions asked.
              </p>
            </section>
